...
function Button({id}: IaddProduct) {
  ...
  return (
    <div className="bg1 rounded-[3.87rem] px-4 py-3 flex gap-4 lg:px-5 lg:py-4 lg:gap-6 lg:min-w-40">
      <button onClick={()=> handleDecreaseQty(id)} className="cursor-pointer">
        <svg className="text-black rounded-xl transition-colors duration-400 hover:bg-black hover:text-white hover:rounded-xl" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
      ...
      <span className="text-sm font-medium lg:text-base min-w-6 lg:min-w-8 text-center">{productQty(id)}</span>
      <button onClick={()=> handleIncreaseQty(id)} className="cursor-pointer">
        <svg className="text-black rounded-xl transition-colors duration-400 hover:bg-black hover:text-white hover:rounded-xl" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
