        ...
        <div className="flex justify-between items-start">
          ...
          <div>
            <button onClick={()=> handleRemoveProduct(id)}>
              <svg className="lg:w-5 lg:h-6  cursor-pointer transition-transform duration-300 hover:scale-125" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
