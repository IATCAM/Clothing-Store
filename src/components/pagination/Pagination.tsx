  ...
  return (
    <div>
      <ReactPaginate
        ...
        previousLinkClassName="flex items-center border border-gray-200 py-2 px-[0.88rem] rounded-lg text-sm font-medium mr-2"
        nextLinkClassName="flex items-center  border border-gray-200 py-2 px-[0.88rem] rounded-lg text-sm font-medium ml-2"
