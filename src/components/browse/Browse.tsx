      ...
      <div className="grid grid-cols-1 gap-4 items-center lg:grid-cols-5 lg:gap-5 lg:mx-16">
          ...
          <div className="lg:col-span-2 relative group">
            <Link href="/style/casual">
              <img className="rounded-[1.25rem] w-full h-[11.87rem] lg:w-full lg:h-[18.06rem]  transition-transform duration-300 group-hover:scale-105" src="https://i.postimg.cc/mk1FFWh9/casual1.png" alt="" />
         ...
         <div className="lg:col-span-3 relative group">
          <Link href="/style/formal">
            <img className="rounded-[1.25rem] w-full h-[11.87rem] lg:w-full lg:h-[18.06rem] transition-transform duration-300 group-hover:scale-105" src="https://i.postimg.cc/t4gTwHNH/formal1.png" alt="" />
        ...
        <div className="lg:col-span-3 relative group">
          <Link href="/style/party">
            <img className="rounded-[1.25rem] w-full h-[11.87rem] lg:w-full lg:h-[18.06rem] transition-transform duration-300 group-hover:scale-105" src="https://i.postimg.cc/7PgfT9Zj/party1.png" alt="" />
        ...
        <div className="lg:col-span-2 relative group">
          <Link href="/style/gym">
            <img className="rounded-[1.25rem] w-full h-[11.87rem] lg:w-full lg:h-[18.06rem] transition-transform duration-300 group-hover:scale-105" src=" https://i.postimg.cc/gkWLM57Y/gym1.png" alt="" />
