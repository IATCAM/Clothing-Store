            ...
            <div>
                ...
                <div>
                     <div className="flex flex-wrap items-center gap-[0.77rem] mt-4 lg:gap-4">
                        {colors.map((color) => (
                        <button key={color} onClick={() => setSelectedColor(color)} className="border border-gray-200 stroke-black rounded-full w-[2.44rem] h-[2.44rem] cursor-pointer" style={{ backgroundColor: color }}>
                            {selectedColor === color && (
